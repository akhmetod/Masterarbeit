...
S1_optimalLinSVMCost <- S1_linSVM_Tune$best.parameters$cost
S1_optimalRBFSVMGamma <- S1_RBFSVM_Tune$best.parameters$gamma
S1_optimalRBFSVMCost <- S1_RBFSVM_Tune$best.parameters$cost
...
# all(as.numeric(S1_linSVM_yPred) == apply(S1_linSVM_yProbPred, 1, function(x) which.max(x)))
...
S1_dummyDF <- matrix(NA, nrow = nrow(validDF), ncol = nlevels(validDF$y))

for (i in c(1:nlevels(validDF$y))) {
    S1_dummyDF[,i] <- as.numeric(validDF[1] == i)

}
rm(i)

S1_MLR_ROC_1 <- roc(S1_dummyDF[,1], S1_MLR_yProbPred[,1])
S1_MLR_ROC_2 <- roc(S1_dummyDF[,2], S1_MLR_yProbPred[,2])
S1_MLR_ROC_3 <- roc(S1_dummyDF[,3], S1_MLR_yProbPred[,3])
S1_MLR_ROC_4 <- roc(S1_dummyDF[,4], S1_MLR_yProbPred[,4])

S1_MLR_AUC <- round(as.numeric(lapply(list(S1_MLR_ROC_1,S1_MLR_ROC_2,
                                           S1_MLR_ROC_3,S1_MLR_ROC_4),
                                        function(x) auc(x))),4)
S1_MLR_AUC_Mean <- round(mean(S1_MLR_AUC),4)

S1_linSVM_ROC_1 <- roc(S1_dummyDF[,1], S1_linSVM_yProbPred[,1])
S1_linSVM_ROC_2 <- roc(S1_dummyDF[,2], S1_linSVM_yProbPred[,2])
S1_linSVM_ROC_3 <- roc(S1_dummyDF[,3], S1_linSVM_yProbPred[,3])
S1_linSVM_ROC_4 <- roc(S1_dummyDF[,4], S1_linSVM_yProbPred[,4])

S1_linSVM_AUC <- round(as.numeric(lapply(list(S1_linSVM_ROC_1,S1_linSVM_ROC_2,
                                              S1_linSVM_ROC_3, S1_linSVM_ROC_4), 
                                         function(x) auc(x))),4)
S1_linSVM_AUC_Mean <- mean(S1_linSVM_AUC)

S1_RBFSVM_ROC_1 <- roc(S1_dummyDF[,1], S1_RBFSVM_yProbPred[,1])
S1_RBFSVM_ROC_2 <- roc(S1_dummyDF[,2], S1_RBFSVM_yProbPred[,2])
S1_RBFSVM_ROC_3 <- roc(S1_dummyDF[,3], S1_RBFSVM_yProbPred[,3])
S1_RBFSVM_ROC_4 <- roc(S1_dummyDF[,4], S1_RBFSVM_yProbPred[,4])

S1_RBFSVM_AUC <- round(as.numeric(lapply(list(S1_RBFSVM_ROC_1,S1_RBFSVM_ROC_2,
                                              S1_RBFSVM_ROC_3, S1_RBFSVM_ROC_4), 
                                         function(x) auc(x))),4)
S1_RBFSVM_AUC_Mean <- mean(S1_RBFSVM_AUC)

S1_MLR_ROC <- ggroc(list(S1_MLR_ROC_1,S1_MLR_ROC_2,S1_MLR_ROC_3,S1_MLR_ROC_4), 
...
ggsave(plot = S1_MLR_ROC, filename = "./Abbildungen/Abbildung_6_9_a.pdf", 
       width = 297, height = 210, units = "mm")

S1_linSVM_ROC <- ggroc(list(S1_linSVM_ROC_1,S1_linSVM_ROC_2,
                            S1_linSVM_ROC_3,S1_linSVM_ROC_4), 
                       size = 1.5, legacy.axes = TRUE) +
    theme_light() + geom_abline(slope = 1, intercept = 0, size = 1) +
...
ggsave(plot = S1_linSVM_ROC, filename = "./Abbildungen/Abbildung_6_9_b.pdf", 
       width = 297, height = 210, units = "mm")


S1_RBFSVM_ROC <- ggroc(list(S1_RBFSVM_ROC_1,S1_RBFSVM_ROC_2,S1_RBFSVM_ROC_3,S1_RBFSVM_ROC_4),
                       size = 1.5, legacy.axes = TRUE) +
    theme_light() + geom_abline(slope = 1, intercept = 0, size = 1) +
    labs(y = "Richtig-Positiv-Rate",
         x = "Falsch-Positiv-Rate") + 
...
ggsave(plot = S1_RBFSVM_ROC, filename = "./Abbildungen/Abbildung_6_9_c.pdf", 
       width = 297, height = 210, units = "mm")
...
for (i in c(1:200)) {
    ...
    S1_RBFSVM_Modell <- svm(y ~ X_1 + X_2,
                  ...
                  type = "C-classification",
                  kernel = "radial",
                  gamma = S1_optimalRBFSVMGamma, 
                  cost = S1_optimalRBFSVMCost,
                  probability = TRUE)
    # RBFSVM Vorhersage
    S1_RBFSVM_yPred = predict(S1_RBFSVM_Modell, newdata = validDF[-1])
    # RBFSVM Wahrscheinlichkeit Vorhersage
    ...
    for (j in c(1:nlevels(validDF$y))) {
        S1_dummyDF[,j] <- as.numeric(validDF[1] == j)
    ...
    S1_MLR_AUC[i,]  <- round(as.numeric(lapply(list(S1_MLR_ROC_1,S1_MLR_ROC_2,
                                               S1_MLR_ROC_3,S1_MLR_ROC_4),
                                            function(x) auc(x))),4)
    ...
    S1_linSVM_AUC[i,] <- round(as.numeric(lapply(list(S1_linSVM_ROC_1,S1_linSVM_ROC_2,
                                                  S1_linSVM_ROC_3, S1_linSVM_ROC_4), 
                                             function(x) auc(x))),4)
    ...
    S1_RBFSVM_AUC[i,] <- round(as.numeric(lapply(list(S1_RBFSVM_ROC_1,S1_RBFSVM_ROC_2,
                                                  S1_RBFSVM_ROC_3, S1_RBFSVM_ROC_4), 
                                             function(x) auc(x))),4)
}
...
optimalLinSVMCost <- S2_linSVM_Tune$best.parameters$cost
optimalRBFSVMGamma <- S2_RBFSVM_Tune$best.parameters$gamma
optimalRBFSVMCost <- S2_RBFSVM_Tune$best.parameters$cost
...
# all(as.numeric(S2_linSVM_yPred) == apply(S2_linSVM_yProbPred, 1, function(x) which.max(x)))
# # linSVM Confusion Matrix
...
S2_RBFSVM_Modell <- svm(y ~ .,
                        ...
                        type = "C-classification",
                        kernel = "radial",
                        gamma = optimalRBFSVMGamma, 
                        cost = optimalRBFSVMCost,
                        probability = TRUE)
# RBFSVM Vorhersage
...
ggsave(plot = S2_MLR_ROC, filename = "./Abbildungen/Abbildung_6_11_a.pdf", 
       width = 297, height = 210, units = "mm")
...
ggsave(plot = S2_linSVM_ROC, filename = "./Abbildungen/Abbildung_6_11_b.pdf", 
       width = 297, height = 210, units = "mm")
...
ggsave(plot = S2_RBFSVM_ROC, filename = "./Abbildungen/Abbildung_6_11_c.pdf", 
       width = 297, height = 210, units = "mm")
...
abb612 <- ggplot(S2_Accuracy, aes(x = ID, y = Accuracy, color = ID)) + 
    geom_boxplot() +
    theme_light() +
    labs(y = "Genauigkeit") + 
    scale_x_discrete(limits = c('MLR', 'linSVM', 'RBFSVM')) +
...
ggsave(plot = abb612, filename = "./Abbildungen/Abbildung_6_12.pdf", width = 297, height = 210, units = "mm")
