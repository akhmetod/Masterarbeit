...
S2_optimalLinSVMCost <- S2_linSVM_Tune$best.parameters$cost
S2_optimalRBFSVMGamma <- S2_RBFSVM_Tune$best.parameters$gamma
S2_optimalRBFSVMCost <- S2_RBFSVM_Tune$best.parameters$cost
...
ggsave(plot = abb612, filename = "./Abbildungen/Abbildung_7_1_b.pdf", width = 297, height = 210, units = "mm")
