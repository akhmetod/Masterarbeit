...
c1 <- ggplot(data = dfSurveyNew, aes(x = cuadrantes, fill = cuadrantes)) +
            ...
            scale_fill_discrete("Armutskategorie",
                                ...
                                labels = c("extreme Armut", "gemilderte Armut", 
                                           "anfällige Armut wegen Einkommen", "anfällige Armut wegen Sozialmängeln", "keine Armut")) +
...
c4 <- ggplot(data = dfSurveyNew, aes(x = schoolYears, fill = cuadrantes)) +
            ...
            theme(plot.title = element_text(size = 14, face = "bold"),
                  ...
                  axis.line.y = element_line(color = "black", size = 0.5),
                  axis.text.x = element_text(size = 10),
                  axis.text.y = element_text(size = 10)) + facet_grid(ic_rezedu ~ ., labeller = as_labeller(c('0' = 'Keine Verzögerung',
                                                                                                              '1' = 'Mit Verzögerung')))
